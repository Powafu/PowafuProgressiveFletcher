...
import org.bot_management.data.Launcher;
import org.bot_management.data.QuickLaunch;
...
public class BotManagement {
    ...
    public static List<LaunchedClient> getRunningClients() {
        final String apiKey;
        try {
            ...
            if (!response.isSuccessful()) {
                Log.severe("Can't find running clients. Response unsuccessful.");
                return null;
            }
        ...
        Log.severe("Can't find running clients");
        return null;
    }
